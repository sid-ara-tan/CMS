        ...
        <div>
              <div id="search_div">
                <div align="center" class="search_header">
                    ...
                    <h2>Select level, term and type of course to assign</h2>
                </div>
                  
                <div class="search_form">
                     <?php echo form_open('admin/course/manage_irregular_student_form','id=" "');?>
                       <table cellpadding="0" cellspacing="20" border="0">
                           <?php
                            ...
                            <tr>
                                ...
                                <td><?php echo form_dropdown('Type',$options,set_value('Type'),'id="Type"');?></td>
                            </tr>
                            <tr>
                                <td></td>
